...
def main():
    with sync_playwright() as p:
        ...
        print("[1] トップページにアクセス...")
        page.goto(LOGIN_URL)
        take_screenshot(page, "step1_login_page")
        ...
        take_screenshot(page, "step2_credentials_entered")

        # 2. TOTP認証コードを送信
        print("[3] TOTP認証ページに移動...")
        page.wait_for_url(f"{BASE_URL}/adm-portal/totp")  # TOTPページを待つ
        take_screenshot(page, "step3_totp_page")
        ...
        take_screenshot(page, "step7_logged_out")
